                    ...
                    <div class="bg-white p-7 rounded-[2rem] border shadow-sm flex-1 flex flex-col overflow-hidden">
                        <div class="flex justify-between items-center mb-5 shrink-0 flex-wrap gap-3">
                            ...
                            <div id="gen-folder-select-wrap" class="flex items-center gap-2">
                                <label class="text-[11px] font-black uppercase text-slate-400">Anno</label>
                                <select id="gen-anno-filter" onchange="generator.filterFolderByAnno()"
                                    class="bg-slate-50 border border-slate-200 rounded-xl px-3 py-2 font-bold text-[12px] text-slate-700 outline-none focus:border-blue-400">
                                ...
                                <select id="gen-folder-select" onchange="generator.onFolderChange()"
                                    class="bg-slate-50 border border-slate-200 rounded-xl px-3 py-2 font-bold text-[12px] text-slate-700 outline-none focus:border-blue-400 w-[220px]">
