    ...
    prepareForm: () => {
        ...
        allTags.forEach(tag=>{
            ...
            if(isLetters){
                ...
                const onchange = (tag.toLowerCase() === 'fascicolo')
                    ? ` onchange="archive.autoFillForm(this.value, document.querySelector('#form-container input[name=anno_fascicolo]')?.value)"`
                    : '';
