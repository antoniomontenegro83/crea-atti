...
Object.assign(generator, {
    ...
    uploadTemplate: async (input) => {
        ...
        try{
            ...
            // 3. Converti docx → HTML con mammoth (fedele al Word) o fallback parser interno
            let bodyHtml = '';
            try {
                if (typeof mammoth !== 'undefined') {
                    ...
                    bodyHtml = generator.docxToHtml(zip, xml);
                }
            } catch(e) {
                console.warn('mammoth error, fallback parser:', e);
                bodyHtml = generator.docxToHtml(zip, xml);
            }
